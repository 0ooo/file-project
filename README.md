...
- `MAX_CHUNK_SIZE`: Максимальный размер каждого чанка файла в байтах.
- `MAX_FILE_SIZE`: Максимально допустимый размер загружаемого файла в байтах.
- `CLEANUP_INTERVAL`: Интервал в миллисекундах для очистки незавершенных загрузок.
- `MAX_AGE`: Максимальное время в миллисекундах для хранения незавершенных загрузок.
